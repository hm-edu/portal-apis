...
func (c *sSLServiceClient) ListCertificates(ctx context.Context, in *ListSslRequest, opts ...grpc.CallOption) (*ListSslResponse, error) {
	...
	err := c.cc.Invoke(ctx, SSLService_ListCertificates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sSLServiceClient) CertificateDetails(ctx context.Context, in *CertificateDetailsRequest, opts ...grpc.CallOption) (*SslCertificateDetails, error) {
	...
	err := c.cc.Invoke(ctx, SSLService_CertificateDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sSLServiceClient) IssueCertificate(ctx context.Context, in *IssueSslRequest, opts ...grpc.CallOption) (*IssueSslResponse, error) {
	...
	err := c.cc.Invoke(ctx, SSLService_IssueCertificate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sSLServiceClient) RevokeCertificate(ctx context.Context, in *RevokeSslRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, SSLService_RevokeCertificate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smimeServiceClient) ListCertificates(ctx context.Context, in *ListSmimeRequest, opts ...grpc.CallOption) (*ListSmimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmimeService_ListCertificates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smimeServiceClient) IssueCertificate(ctx context.Context, in *IssueSmimeRequest, opts ...grpc.CallOption) (*IssueSmimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmimeService_IssueCertificate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smimeServiceClient) RevokeCertificate(ctx context.Context, in *RevokeSmimeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, SmimeService_RevokeCertificate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSmimeServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedSmimeServiceServer) testEmbeddedByValue()                      {}
...
func RegisterSmimeServiceServer(s grpc.ServiceRegistrar, srv SmimeServiceServer) {
	// If the following call pancis, it indicates UnimplementedSmimeServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
